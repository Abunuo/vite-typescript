...
axios.interceptors.request.use(config => {
  ...
  // }
  if(config.headers.post["Content-Type"] === 'application/x-www-form-urencode') {
...
interface requestMethods {
  (url: string, data?: object, params?: object): AxiosPromise<any>
}

export const post:requestMethods = (url, data = {}) => {
  return axios({
    url,
    method: 'post',
    data,
...
export const get:requestMethods = (url, params = {}) => {
  return axios({
    url,
    method: 'get',
    params
